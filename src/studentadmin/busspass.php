    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="busspass.php">
              <i class="fa fa-puzzle-piece menu-icon"></i>
              <span class="menu-title">BusPass</span>
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="notification.php">
              <i class="fa fa-link menu-icon"></i>
              <span class="menu-title">BusPass Notification</span>
            </a>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="studentprofile.php">Student Profile</a></li>
...
if(isset($_POST['submit']))
{
  ...
  $ins="  INSERT INTO passform(name,lname,ddate,phone,email,state,paddress,address,postcode,city,fromplace,toplace)VALUES('$name','$lname','$ddate','$phone','$email','$state','$paddress','address','$Postcode','$city','$from_city','$to_city')";
...
<div class="col-12 grid-margin" style="margin-top: 100px;">
              <div class="card" style="width:1200px; margin-left: 20px;l">
                <div class="card-body">
                  <h4 class="card-title">Busspass Registration Form</h4>
                  <form class="form-sample" method="post">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">From Place</label>
                          <div class="col-sm-9">
...
<div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">To Place</label>
                          <div class="col-sm-9">
...
<div class="col-md-6">
                       ...
                       <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" placeholder="dd/mm/yyyy"/ name="ddate">
                          </div>
                        </div>
                      </div>
                    </div>
