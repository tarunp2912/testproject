...
<!--             <a class="nav-link" data-toggle="collapse" href="#maps" aria-expanded="false" aria-controls="maps">
   ...
   <br><br><br>
       ...
       <div class="main-panel">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Student Pass Data</h4>
                      ...
                      <table id="sortable-table-2" class="table table-striped">
                        <thead>
                          <tr>
                            ...
                            <th class="sortStyle">id <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">Name  <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">Lastname    <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">DOB     <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">Phone   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">Email   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">State   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">Permanent Address   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">Current Address   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">postcode   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">City   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">From place   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle">To place   <i class="fa fa-angle-down"></i></th>
                            <th class="sortStyle" colspan="2">Check<i class="fa fa-angle-down"></i></th>




                            <th class="sortStyle">Create Pass   <i class="fa fa-angle-down"></i></th>
 ...
 $selectquery = "SELECT * FROM passform ";
 ...
 $res = mysqli_fetch_assoc($query);
   ...
   ?>         
            ...
            <td><?php echo $res['fromplace'];?></td>
            <td><?php echo $res['toplace'];?></td>


           <td><a href="aprove.php?student_id=<?php echo $res['id']?>"><button>Approve</button></a></td>
            <form action="delete.php" method="post">
                <input type="hidden" name="id" value="<?php echo $res['id'];?>">
                <td><input type="submit" name="delete" class="" value="Decline"></td>
            </form>
           <td><a href="createpass.php?student_id=<?php echo $res['id']?>"><button>Create</button></a></td>
