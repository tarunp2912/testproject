...
<div class="main" style="margin-top:80px; margin-left:110px; border:2px solid;">
  <h1><center>Buspass</center></h1><br><br><br>
      <form method="post">
       <lable style="font-size: 20px; margin-right: 10px;">First Name:</lable><input type="text" name="name" style="border-top:0px; border-left: 0px;border-right: 0px; width: 300px;" value="<?php echo $data['name'];?>">
        <lable style="font-size: 20px; margin-right: 10px; margin-left: 20px;">Last Name:</lable><input type="text" name="name" style="border-top:0px; border-left: 0px;border-right: 0px; width: 300px;" value="<?php echo $data ['lname'];?>"><br><br><br>
         <lable style="font-size: 20px; margin-right: 10px;">Phone Number:</lable><input type="text" name="name" style="border-top:0px; border-left: 0px;border-right: 0px; width: 300px;" value="<?php echo $data['phone']; ?>">
         <lable style="font-size: 20px; margin-right: 10px; margin-left: 25px;">Email:</lable><input type="text" name="name" style="border-top:0px; border-left: 0px;border-right: 0px; width: 300px;" value="<?php echo $data ['email']; ?>"><br><br><br>
         <lable style="font-size: 20px; margin-right: 10px; ">Address:</lable><input type="text" name="name" style="border-top:0px; border-left: 0px;border-right: 0px; width: 300px;" value="<?php echo $data['paddress'] ?>">
         <lable style="font-size: 20px; margin-right: 10px; margin-left: 25px;">Your City:</lable><input type="text" name="name" style="border-top:0px; border-left: 0px;border-right: 0px; width: 335px;" value="<?php echo $data['city'] ?>"><br><br><br>
         <lable style="font-size: 20px; margin-right: 10px; ">From place:</lable><input type="text" name="name" style="border-top:0px; border-left: 0px;border-right: 0px; width: 300px;" value="<?php echo $data['fromplace']; ?>">
         <lable style="font-size: 20px; margin-right: 10px; ">To place:</lable><input type="text" name="name" style="border-top:0px; border-left: 0px;border-right: 0px; width: 335px;" value="<?php echo $data ['toplace']; ?>"><br>
        <center> <button style="margin-top:40px;">Download</button></center>
