...
<?php
        ...
        if(isset($_POST["submit"]))
      {
           ...
           $select = mysqli_query($con,"SELECT * FROM Registration WHERE email='$email' AND password='$password' ");
           ...
           if ($row['email'] == $email && $row['password'] == $password)
            {
                if ($row)
                {
                    ...
                    echo "<script>alert('your form is submited');
                        window.location = 'studentadmin/studentprofile.php';</script>";
                     $_SESSION['id']= $row['id'];
...
?>
  ...
  <div class="container">
    <div class="title"><center>Login</center></div><br><br>
    <div class="content">
      <form method="post">
        <div class="user-details" style="margin-left: 400px;">
