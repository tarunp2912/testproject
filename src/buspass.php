    ...
    <div class="page-wrapper">
        ...
        <section class="hero hero-slider-wrapper hero-style-1">
            <div class="hero-slider">
                <div class="slide">
                    <img src="vc.jpg" alt class="slider-bg">
                    <div class="container">
                        <div class="row">
...
if(isset($_POST['submit']))
{
  ...
  $ins="  INSERT INTO passform(name,lname,ddate,phone,email,state,paddress,address,postcode,city)VALUES('$name','$lname','$ddate','$phone','$email','$state','$paddress','address','$Postcode','$city')";
